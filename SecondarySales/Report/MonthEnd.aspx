<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MonthEnd.aspx.cs" Inherits="Report_MonthEnd" %>
                    ...
                    <table width="95%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td align="left" class="pagetitleDetail">
                                <asp:Label ID="lblHeader" runat="server" Text="Report - Month End Open"></asp:Label>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            ...
                            <asp:Button ID="btnCancel" runat="server" CssClass="btn cancelbtn" Text="Clear" />--%>
                                <asp:Button ID="btnSave" runat="server" CssClass="btn Excelbtn" Style="padding-left: 20px;
                                    font-size: 11px;"  Text="Generate Excel" OnClick="btnSave_Click" />
                            </td>
                        </tr>
                        <tr>
                            <td>
