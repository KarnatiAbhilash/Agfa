...
public partial class Report_ZeroConsumption : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        SqlDataReader reader = this.objRep.funZeroConsumption();
        ReportHeader reportHeader = new ReportHeader();
        reportHeader.HeaderText = "Zero Consumption";
        reportHeader.Alignment = Alignments.Left;
        ReportFooter reportFooter = new ReportFooter();
        reportFooter.FooterText = "Zero Consumption";
        ...
        ReportConfiguration.ReportTitle = "Zero Consumption";
