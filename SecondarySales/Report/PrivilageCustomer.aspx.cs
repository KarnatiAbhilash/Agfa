...
public partial class Report_PrivilageCustomer : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        SqlDataReader reader = this.objRep.funPrivillage();
        ReportHeader reportHeader = new ReportHeader();
        reportHeader.HeaderText = "Privilage Customer";
        reportHeader.Alignment = Alignments.Left;
        ReportFooter reportFooter = new ReportFooter();
        reportFooter.FooterText = "Privilage Customer";
        ...
        ReportConfiguration.ReportTitle = "Privilage Customer";
