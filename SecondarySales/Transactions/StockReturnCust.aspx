<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockReturnCust.aspx.cs"
    Inherits="Transactions_StockReturnCust" %>
...
<head>
    ...
    <script type="text/javascript" language="javascript">
     ...
     if($get('txtCustCode').value=="")
     {
            alert("Enter the Customer Number");
            $get('txtCustCode').focus();
     }
     else if($get('ddlInvoceNo').value=="")
     {
            alert("Select the Invoice Number");
            $get('ddlInvoceNo').focus();
     }
     else if($get('txtCustCode').value!="" && $get('ddlInvoceNo').value!="")
            window.open("../Popups/popupCustItem.aspx?SelectType=" + strSelectType +"&strCount="+strCount+"&Dlr="+strDlrCode+"&strType="+strType+"&Cust="+strCust , "CPO", "location=0,status=1,scrollbars=1,toolbar=0,width=900,height=400,resizable=no");
     ...
     function fnValidateSave() {
        ...
        IsValid=false;     
          ...
          if (fnNoBlank(document.getElementById("txtCustCode").value, "Customer", lblMsg) != true) {
                alert(lblMsg.value)
                document.getElementById("txtCustCode").focus();
                return false;
            }
          if (fnComboSelect(document.getElementById("ddlInvoceNo").value, "Dealer Invoice", lblMsg) != true) {
                alert(lblMsg.value)
                document.getElementById("ddlInvoceNo").focus();
                return false;
            }
...
<body>
    <form id="frmStockReturnCust" runat="server">
            ...
            <ContentTemplate>
                ...
                <table width="95%" class="alternatecolorborder" id="TblParam" runat="server" border="0"
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtReturnDate" runat="server" CssClass="commonfont textdropwidth" ></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            Customer:<var class="starColor">*</var>
                        </td>
                        <td align="left">
                            <asp:TextBox type="text" ID="txtCustCode" runat="server" class="commonfont textdropwidthSmall"
                                AutoPostBack="True" OnTextChanged="txtCustCode_TextChanged"></asp:TextBox>
                            <input type="button" value="..." id="btnCust" runat="server" class="popButton" onclick="popCustomer('StockRetCust')" />
                        ...
                        <td align="right">
                            Dealer Invoce No:<var class="starColor">*</var>
                        </td>
                        <td align="left">
                            <asp:DropDownList ID="ddlInvoceNo" runat="server" CssClass="commonfont textdropwidth">
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
