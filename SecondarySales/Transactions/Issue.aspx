            ...
            <center>
                ...
                <table class="HeaderDetailsGrid" width="95%" border="0" cellspacing="0">
                    <tr>
                        ...
                        <td> <asp:Button ID="btnApproved" runat="server" CssClass="btn savebtn1" Text="Approve" OnClick="btnApproved_Click"  Visible="true"/> 
...
<%--                                  <asp:Button ID="Button1" runat="server" CssClass="btn savebtn" Text="Verify" visible="false" OnClick="btnApproved_Click"  />     --%>
