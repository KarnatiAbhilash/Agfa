<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EquipmentProductGroup.aspx.cs" Inherits="Masters_EquipmentProductGroup" %>
                ...
                <asp:GridView ID="gvBudget" runat="server" BorderWidth="1px" BorderColor="#666666"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField ItemStyle-HorizontalAlign="Left" SortExpression="GroupCode" DataTextField="GroupCode"
                            DataNavigateUrlFields="PGID" DataNavigateUrlFormatString="EquipmentProductGroupAddEdit.aspx?New=N&&strCode={0}"
