    ...
    <center>
        ...
        <table width="95%" class="alternatecolorborder" id="TblParam" runat="server" border="0"
            ...
            <tr>
                ...
                <td align="left">
                    <asp:TextBox ID="txtCustCode" ReadOnly="true" Disabled="disabled" runat="server" CssClass="commonfont textdropwidth"></asp:TextBox>
                </td>
                <td align="right">
            ...
            <tr>
                <td>
					...
					<asp:Button ID="btnDemoDetails" runat="server" CssClass="btn addnewrow1" Text="Demo Details"
                     ...
                     <asp:Button ID="InstBase" runat="server" CssClass="btn addnewrow"  Visible="false"
                  OnClick="btnInstall_Base" Text="Install Base" CausesValidation="false" />
