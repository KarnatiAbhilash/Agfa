<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductFamilyMasterAddEdit.aspx.cs" Inherits="Masters_ProductFamilyMasterAddEdit" %>
...
<head>
    ...
    <script type="text/javascript" language="javascript">        
        function popupBudget(strSelectType) {
            ...
            window.open("../Popups/popupBudgetClass.aspx?SelectType=" + strSelectType , "PMP", "location=0,status=1,scrollbars=1,toolbar=0,width=900,height=400,resizable=no");
        }
        ...
        if (fnNoBlank(document.getElementById("txtBudgetClassCode").value, "Budget Class", lblMsg) != true) {
         ...
         if (fnNoSpaceSpecial(document.getElementById("txtProdFamily").value, "Product Family", lblMsg) != true) {
                alert(lblMsg.value)
                document.getElementById("txtProdFamily").focus();
                return false;
            }
         if (fnCheckLength(document.getElementById("txtProdFamily").value, "Product Family", "10", lblMsg) != true) {
                alert(lblMsg.value)
                document.getElementById("txtProdFamily").focus();
                return false;
            }
         if (fnCheckLength(document.getElementById("txtDescrip").value, "Product Family Description", "50", lblMsg) != true) {
                alert(lblMsg.value)
...
<body>
    <form id="frmProductFamilyMasterAddEdit" runat="server">
    <asp:HiddenField ID="hdnPFId" Value="0" runat="server" />
    <center>
       ...
       <table width="95%" class="alternatecolorborder" id="TblParam" runat="server" border="0"
         ...
         <tr>
          ...
          <td align="left">
             <asp:TextBox ID="txtBudgetClassCode" runat="server" ReadOnly="true"
                  CssClass="commonfont textdropwidth" AutoPostBack="True" 
                  ontextchanged="txtBudgetClassCode_TextChanged"></asp:TextBox>
             <input type="button" value="..." id="btnBudget" runat="server" class="popButton" onclick="popupBudget('ProbFamily')" />
          </td>  
          <td align="right">
              Product Family Code:<var class="starColor">*</var>
          </td>
          <td align="left">
             <asp:TextBox ID="txtProdFamily" MaxLength="10" runat="server" CssClass="commonfont textdropwidth"></asp:TextBox>
          </td>
          </tr>
          <tr>       
          <td align="right">
