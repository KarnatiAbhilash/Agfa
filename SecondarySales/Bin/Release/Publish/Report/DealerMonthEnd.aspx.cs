...
public partial class Report_DealerMonthEnd : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (this.IsPostBack || !(this.Session["UserName"].ToString().ToLower() != "admin"))
                return;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        SqlDataReader dealerMonthEnd = clsReports.GetDealerMonthEnd();
        ReportHeader reportHeader = new ReportHeader();
        reportHeader.HeaderText = "Dealer Month End";
        reportHeader.Alignment = Alignments.Left;
        ReportFooter reportFooter = new ReportFooter();
        reportFooter.FooterText = "Dealer Month End";
        ...
        ReportConfiguration.ReportTitle = "Dealer Month End";
        ...
        dealerMonthEnd.CreateExcelReport(ReportConfiguration).SendFileToBrowser(HTTPHandlerAbsolutePath);
    }

    protected bool ValidateDealerCode()
    {
        DataSet dataSet = objDlr.FetchDealerMaster(" where Status=1 and DealerCode='" + this.txtDealerCode.Text.Trim() + "'");
