<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popupBudgetClass.aspx.cs" Inherits="Popups_popupBudgetClass" %>
            ...
            <tr>
                <td align="left">
                    ...
                    <asp:DropDownList ID="ddlsearch" runat="server" CssClass="commonfont textdropwidth">
                        <asp:ListItem Value="BCCode">Budget Class</asp:ListItem>
                        <asp:ListItem Value="BCDescription">Description</asp:ListItem>                        
                    </asp:DropDownList>
                    Value:
                    ...
                    <asp:GridView ID="gvBudget" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Budget Class">
                                <ItemTemplate>
                                    <asp:Label ID="lblBCId" runat="server" Text='<%#Eval("BCId")%>' Visible="false"></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="Description">
                                <ItemTemplate>
                                    <asp:Label ID="lblDesc" runat="server" Text='<%#Eval("BCDescription")%>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>                            
                        </Columns>
