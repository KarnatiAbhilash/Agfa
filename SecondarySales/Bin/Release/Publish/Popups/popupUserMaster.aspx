<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popupUserMaster.aspx.cs" Inherits="Popups_popupUserMaster" %>
...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function FillParentWindow(strSelectType, strUserId,strUserName) {        
            if (strSelectType == "Dealer") {
                window.opener.document.getElementById("txtRespuser").value = strUserId;
                window.opener.document.getElementById("hdnRespUser").value = strUserId;
            }
            else if (strSelectType == "UserMenu") {
                window.opener.document.getElementById("txtUserId").value = strUserId;
                window.opener.document.getElementById("txtUserName").value = strUserName;
                window.opener.__doPostBack('btnGetdata', '');
            }
            else if (strSelectType == "ExecutiveMaster") {
                window.opener.document.getElementById("txtUserId").value = strUserId;
                window.opener.document.getElementById("txtDescrip").value = strUserName;
            }
        ...
        function CheckOtherIsCheckedByGVID(spanChk) {
            ...
            Parent = document.getElementById('gvUser');
...
<body onload="resizewindow()">
    <form id="frmpopupUserMaster" runat="server">
            ...
            <tr>
                <td>
                    <asp:GridView ID="gvUser" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                        OnPageIndexChanging="gvUser_PageIndexChanging" Width="100%" GridLines="None"
