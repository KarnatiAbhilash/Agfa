<%@ page language="C#" autoeventwireup="true" inherits="Transactions_IssueAddEdit, App_Web_3kgqgt3u" %>
                    ...
                    <table width="95%" class="alternatecolorborder" id="TblParam" runat="server" border="0"
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:Button ID="btnView" runat="server" Style="width: 59px;" Text="View" OnClientClick="download();" Visible="false"  ></asp:Button>
                                <br />
