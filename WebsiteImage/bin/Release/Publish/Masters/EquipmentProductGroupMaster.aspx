<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EquipmentProductGroupMaster.aspx.cs" Inherits="Masters_EquipmentProductGroupMaster" %>
...
<body>
    <form id="frmEqipment" runat="server">
    ...
    <asp:UpdatePanel ID="CalPanel" runat="server">
        <ContentTemplate>
            <center>
                ...
                <table width="95%" border="0" cellspacing="" cellpadding="0">
                    <tr>
                        <td align="left" class="pagetitleDetail">
                           Equipment Product Group Master
                        </td>
                    </tr>
                </table>
                <br />
                ...
                <asp:GridView ID="gvEquipment" runat="server" BorderWidth="1px" BorderColor="#666666"
                    GridLines="None" CellPadding="5" Width="95%" AllowPaging="True" EmptyDataText="No Record(s) Found."
                          AutoGenerateColumns="False" AllowSorting="True" OnRowDeleting="gvEquipment_RowDeleting"
                    OnSorting="gvEquipment_Sorting" PagerStyle-HorizontalAlign="Left" OnRowCommand="gvEquipment_RowCommand"
                    OnPageIndexChanging="gvEquipment_PageIndexChanged" OnRowDataBound="gvEquipment_RowDataBound">
                   <Columns>
                        ...
                        <asp:HyperLinkField ItemStyle-HorizontalAlign="Left" SortExpression="ProductGroup"
                            DataTextField="ProductGroup" DataNavigateUrlFields="Id" DataNavigateUrlFormatString="EquipmentProductGroupMasterAddEdit.aspx?New=N&&strCode={0}"
                            HeaderStyle-ForeColor="White" HeaderText="Equipment Product Code" >
                        <HeaderStyle ForeColor="White" />
                        <ItemStyle HorizontalAlign="Left" />
                        </asp:HyperLinkField>
                        <asp:BoundField ItemStyle-HorizontalAlign="Left" SortExpression="ProductDesc" DataField="ProductDesc"
