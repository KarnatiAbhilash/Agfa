<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductFamilyMaster.aspx.cs"
    Inherits="Masters_ProductFamilyMaster" %>
...
<body>
    <form id="frmProductFamilyMaster" runat="server">
    ...
    <asp:UpdatePanel ID="CalPanel" runat="server">
        <ContentTemplate>
            <center>
                ...
                <asp:GridView ID="gvProd" runat="server" BorderWidth="1" BorderColor="#666666" GridLines="None"
                    CellPadding="5" Width="95%" AllowPaging="true" EmptyDataText="No Record(s) Found."
                    AutoGenerateColumns="false" AllowSorting="true" OnRowDeleting="gvProd_RowDeleting"
                    OnSorting="gvProd_Sorting" PagerStyle-HorizontalAlign="Left" OnRowCommand="gvProd_RowCommand"
                    OnPageIndexChanging="gvProd_PageIndexChanged" OnRowDataBound="gvProd_RowDataBound">
                    <Columns>
                        <asp:ButtonField ItemStyle-Width="50px" ButtonType="Image" CommandName="Delete" ImageUrl="../Common/Images/delete.gif" />
                        <asp:BoundField DataField="PFID" HeaderStyle-CssClass="HiddenField" ItemStyle-CssClass="HiddenField"
                            HeaderText="ID" />
                        <asp:HyperLinkField ItemStyle-HorizontalAlign="Left" SortExpression="PFCode" DataTextField="PFCode"
                            DataNavigateUrlFields="PFID" DataNavigateUrlFormatString="ProductFamilyMasterAddEdit.aspx?New=N&&strCode={0}"
                            HeaderStyle-ForeColor="White" HeaderText="Product Family" />
                        <asp:BoundField ItemStyle-HorizontalAlign="Left" SortExpression="BCCode" DataField="BCCode"
                            HeaderText="Budget Class" />
                        <asp:BoundField ItemStyle-HorizontalAlign="Left" SortExpression="PFDesc" DataField="PFDesc"
