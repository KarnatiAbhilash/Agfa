<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DemoConsumption.aspx.cs" Inherits="Report_DemoConsumption" %>
                ...
                <table width="95%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="left" class="pagetitleDetail">
                            <asp:Label ID="lblHeader" runat="server" Text="Report-Demo Film Consumption"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
