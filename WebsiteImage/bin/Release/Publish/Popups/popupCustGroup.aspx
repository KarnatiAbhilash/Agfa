<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popupCustGroup.aspx.cs" 
    Inherits="Popups_popupCustGroup" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function FillParentWindow(strSelectType, strBCCode) {
            if (strSelectType == "ProbFamily") {                
                window.opener.document.getElementById("txtCustGroup").value = strBCCode;
            }
                ...
                window.opener.document.getElementById("txtBudgetClassCode").value = strBCCode;
                window.opener.document.getElementById("txtProdFamily").value="";
                window.opener.document.getElementById("txtCustGroup").value="";
            }
                    ...
                    <asp:GridView ID="gvBudget" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Customer Group">
                                <ItemTemplate>
                                    <asp:Label ID="lblCustId" runat="server" Text='<%#Eval("CustId")%>' Visible="false"></asp:Label>
               
                                    <asp:Label ID="lblGroupCode" runat="server" Text='<%#Eval("CustomerGroup")%>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Customer Group Description">
                                <ItemTemplate>
                                    <asp:Label ID="lblGroupDesc" runat="server" Text='<%#Eval("CustomerGroupDesc")%>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>                            
                        </Columns>
