<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popupProductGroup.aspx.cs" Inherits="Popups_popupProductGroup" %>
...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function FillParentWindow(strSelectType, strProdGroup) {
           if (strSelectType == "ItemMaster") {                
                window.opener.document.getElementById("txtProdGroup").value = strProdGroup;
            }  
...
<body onload="resizewindow()">
    <form id="frmpopupProductGroup" runat="server">
                    ...
                    <asp:GridView ID="gvProdGrp" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Product Family">
                                <ItemTemplate>
                                    <asp:Label ID="lblProdFamily" runat="server" Text='<%#Eval("PFCode")%>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField> 
                            <asp:TemplateField HeaderText="Description">
                                <ItemTemplate>
                                    <asp:Label ID="lblDesc" runat="server" Text='<%#Eval("GroupDesc")%>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>                            
                        </Columns>
