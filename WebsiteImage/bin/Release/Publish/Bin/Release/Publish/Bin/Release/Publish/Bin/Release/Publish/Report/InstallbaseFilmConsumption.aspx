<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InstallbaseFilmConsumption.aspx.cs" Inherits="Report_InstallbaseFilmConsumption" %>
                ...
                <table width="95%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="left" class="pagetitleDetail">
                            <asp:Label ID="lblHeader" runat="server" Text="Report-Install base Film Consumption"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
