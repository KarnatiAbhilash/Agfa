<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemMovement.aspx.cs" Inherits="ItemMovement" %>
...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Validate() {
            ...
            if($get('txtItemCode').value == '')
            { alert("Select the ItemCode"); return false; }
                ...
                <table width="95%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="left" class="pagetitleDetail">
                            <asp:Label ID="lblHeader" runat="server" Text="Report - ItemMovement"></asp:Label>
                        </td>
                    </tr>
                </table>
                <table width="95%" class="alternatecolorborder" id="TblParam" runat="server" border="0"
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="4">
                            <asp:TextBox ID="txtItemCode" AutoPostBack="true" CssClass="commonfont textdropwidth"
                                runat="server" OnTextChanged="DummyTxt_TextChanged"></asp:TextBox>
                            <%--    <input type="text"  size="10" id="txtItemCode" onchange="__doPostBack('DummyTxt','')"  runat="server" width="60px"
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="6">
                            <asp:DropDownList ID="ddlSalesType" ReadOnly="true" runat="server" CssClass="commonfont textdropwidth">
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
