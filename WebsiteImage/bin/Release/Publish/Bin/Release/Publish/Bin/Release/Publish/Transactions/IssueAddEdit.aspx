...
<head>
    ...
    <script type="text/javascript" language="javascript">
     ...
     if(strType!=0 && $get('txtCustCode').value != '' && $get('txtInvoiceNo').value != '')
            ...
            else if ($get('txtCustCode').value == '')
                alert('Select the Customer Code');
            else if ($get('txtInvoiceNo').value == '') { alert('Enter the InvoiceNo'); $get('txtInvoiceNo').focus(); }
          ...
          <tr>                 
            ...
            <td align="left">
              <asp:DropDownList ID="ddlSalesType" AutoPostBack="true" runat="server" 
                    ...
                    onselectedindexchanged="ddlSalesType_SelectedIndexChanged"></asp:DropDownList>
            </td>
          </tr>
          <tr>

            <td align="right">
                 Customer Code:<var class="starColor">*</var>
            </td>
            <td align="left" >
               <asp:TextBox AutoPostBack="true" type="text" id="txtCustCode" runat="server" 
                    class="commonfont textdropwidthSmall" ontextchanged="txtCustCode_TextChanged" ></asp:TextBox>
           ...
           <td align="right">
          <asp:Label id="lblUplTxt" Text="Upload File:" Visible="false" runat="server" />
          </td>
          <td align="left">
            
              <asp:FileUpload ID="FileUpload1" runat="server" onchange="onupload()" Visible="false" EnableViewState="True" ViewStateMode="Enabled"  />
         
              <asp:Button ID="View" runat="server" Style="width: 59px;" Text="View" OnClientClick="download();"  Visible="false" ></asp:Button>
              <br />

                <asp:Label ID="lblUploadFileName" runat="server" />

<%--              <asp:RegularExpressionValidator ID="regval1" ForeColor="Red" runat="server" ValidationGroup="gr1"
                        ControlToValidate="FileUpload1"
                  ValidationExpression="^([a-zA-Z].*|[1-9].*)\.(((p|P)(d|D)(f|F)))$ " >Only Accept pdf </asp:RegularExpressionValidator>--%>

<%--                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ValidationExpression="([a-zA-Z0-9\s_\\.\-:])+(.jpg|.png|.pdf)$"
                        ControlToValidate="FileUpload1" runat="server" ForeColor="Red" ErrorMessage="Please select a valid JPG or PDF File file."
                        Display="Dynamic" />
                    <br />--%>
          </td>          
