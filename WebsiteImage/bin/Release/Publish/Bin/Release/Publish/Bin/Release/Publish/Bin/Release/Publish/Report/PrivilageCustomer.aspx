<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrivilageCustomer.aspx.cs" Inherits="Report_PrivilageCustomer" %>
                ...
                <table width="95%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="left" class="pagetitleDetail">
                            <asp:Label ID="lblHeader" runat="server" Text="Report-Privilage Customer"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
