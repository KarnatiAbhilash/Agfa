<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TopFrame.ascx.cs" Inherits="UserControl_TopFrame" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" runat="server" />
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td style="width: 10%" align="left">
                    <img id="imgAgfaSmall" runat="server" src="~/Common/Images/AgfaLogoFinalSmall.gif"
                        alt="" />
                </td>
            ...
            <tr>
                <td align="center">
                    <asp:Menu ID="MenuAgfa"  runat="server" DynamicHorizontalOffset="0" Orientation="Horizontal"
                        StaticEnableDefaultPopOutImage="false" StaticBottomSeparatorImageUrl="~/Common/Images/arrow_button_white.png">
                        <StaticMenuItemStyle Height="25px" Width="10px" CssClass="HeaderMenuStaticHome" />
