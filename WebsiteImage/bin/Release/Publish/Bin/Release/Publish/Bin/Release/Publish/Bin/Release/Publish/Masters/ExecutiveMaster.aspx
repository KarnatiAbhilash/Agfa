<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExecutiveMaster.aspx.cs"
    Inherits="Masters_ExecutiveMaster" %>
...
<body>
    <form id="frmExecutiveMaster" runat="server">
    ...
    <asp:UpdatePanel ID="CalPanel" runat="server">
        <ContentTemplate>
            <center>
                ...
                <asp:GridView ID="gvExecutive" runat="server" BorderWidth="1" BorderColor="#666666"
                    GridLines="None" CellPadding="5" Width="95%" AllowPaging="true" EmptyDataText="No Record(s) Found."
                    AutoGenerateColumns="false" AllowSorting="true" OnRowDeleting="gvExecutive_RowDeleting"
                    OnSorting="gvExecutive_Sorting" PagerStyle-HorizontalAlign="Left" OnRowCommand="gvExecutive_RowCommand"
                    OnPageIndexChanging="gvExecutive_PageIndexChanged" OnRowDataBound="gvExecutive_RowDataBound">
                    <Columns>
                        <asp:ButtonField ItemStyle-Width="50px" ButtonType="Image" CommandName="Delete" ImageUrl="../Common/Images/delete.gif" />
                        <asp:BoundField DataField="EMID" HeaderStyle-CssClass="HiddenField" ItemStyle-CssClass="HiddenField"
                            HeaderText="ID" />
                        <asp:HyperLinkField ItemStyle-HorizontalAlign="Left" SortExpression="ExecutiveCode"
                            DataTextField="ExecutiveCode" DataNavigateUrlFields="EMID" DataNavigateUrlFormatString="ExecutiveMasterAddEdit.aspx?New=N&&strCode={0}"
                            HeaderStyle-ForeColor="White" HeaderText="Executive Code" />
                        <asp:BoundField ItemStyle-HorizontalAlign="Left" SortExpression="ExecutiveDesc" DataField="ExecutiveDesc"
