<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReceiptAddEdit.aspx.cs" Inherits="Transactions_ReceiptAddEdit" %>
...
<head>
    ...
    <script type="text/javascript" language="javascript">
     ...
     function popupItem(strSelectType,strCount,strDlrCode,strType)
      {    
          if($get('txtInvoiceNo').value=="")
             {
                    alert("Enter the Invoice Number");
                    $get('txtInvoiceNo').focus();
             }
          else if($get('txtInvoiceNo').value!="")                   
             window.open("../Popups/popupDealerItem.aspx?SelectType=" + strSelectType +"&strCount="+strCount+"&Dlr="+strDlrCode+"&strType="+strType+"&PONo="+$get("txtPONo").value , "CPO", "location=0,status=1,scrollbars=1,toolbar=0,width=900,height=400,resizable=no");
      }
        ...
        for(i=1;i<=hdnCount;i++)
         {
           ...
           // alert(  (parseInt(document.getElementById("txtQty_"+i).value,10) <= 0))
           if (parseInt(document.getElementById("txtQty_"+i).value,10) <= 0) {
...
<body>
    <form id="frmReceiptAddEdit" runat="server">
            ...
            <ContentTemplate>
                ...
                <table width="95%" class="alternatecolorborder" id="TblParam" runat="server" border="0"
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtSupplier" runat="server" Text="Agfa" CssClass="commonfont textdropwidthSmall"
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtMonth" runat="server" CssClass="commonfont textdropwidthSmall"
                                ReadOnly="true"></asp:TextBox>
                        </td>
                        <td align="right">
                            Year:
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtYear" runat="server" CssClass="commonfont textdropwidthSmall"
                                ReadOnly="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtPONo" runat="server" CssClass="commonfont textdropwidthSmall"
                                ReadOnly="true"></asp:TextBox>
                        </td>
                        <td align="right">
                        ...
                        <td align="right">
                            Invoice Date:<var class="starColor">*</var>
                        </td>
                        <td align="left">
