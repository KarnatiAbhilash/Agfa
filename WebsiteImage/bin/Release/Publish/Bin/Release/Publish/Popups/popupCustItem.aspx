<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popupCustItem.aspx.cs" Inherits="Popups_popupCustItem" %>
...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function FillParentWindow(strSelectType,strCount,strItemId,strItemCode,strDesc1,strDesc2,strEuPrice,strPerSqrMt,strProfitAgreed) {
         if (strSelectType == "Issue") { 
                ...
                window.opener.document.getElementById("txtUnitPrice_" + strCount).value=strEuPrice; 
                window.opener.document.getElementById("hdnProfitAgreed_" + strCount).value=strProfitAgreed;                 
...
<body onload="resizewindow()">
    <form id="frmpopupCustItem" runat="server">
                ...
                <td>
                    <asp:GridView ID="gvItem" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="EU Price">
                                <ItemTemplate>
                                    <asp:Label ID="lblEUPrice" runat="server" Text='<%#Eval("EUPrice")%>'></asp:Label>
                                    <asp:HiddenField ID="hidProfitAgreed" runat="server" Value='<%#Eval("ProfitAgreed")%>' />
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="PerSqrMt">
                                <ItemTemplate>
                                    <asp:Label ID="lblEUPerSqrMt" runat="server" Text='<%#Eval("EUPerSqrMt")%>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                        </Columns>
