<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZeroConsumption.aspx.cs" Inherits="Report_ZeroConsumption" %>
                ...
                <table width="95%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="left" class="pagetitleDetail">
                            <asp:Label ID="lblHeader" runat="server" Text="Report-Zero Consumption"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
