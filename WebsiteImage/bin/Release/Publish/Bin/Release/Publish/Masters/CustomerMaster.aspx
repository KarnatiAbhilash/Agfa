<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerMaster.aspx.cs" Inherits="Masters_CustomerMaster" %>
        ...
        <ContentTemplate>
            <center>
               ...
               <br />
                ...
                <asp:GridView ID="gvCust" runat="server" BorderWidth="1" BorderColor="#666666"
                    GridLines="None" CellPadding="5" Width="95%" AllowPaging="true" EmptyDataText="No Record(s) Found."
                    AutoGenerateColumns="false" AllowSorting="true" OnRowDeleting="gvCust_RowDeleting"
                    OnSorting="gvCust_Sorting" PagerStyle-HorizontalAlign="Left" OnRowCommand="gvCust_RowCommand"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CustCode" HeaderStyle-CssClass="HiddenField" ItemStyle-CssClass="HiddenField"
                            HeaderText="ID" />
                        <asp:HyperLinkField ItemStyle-HorizontalAlign="Left" SortExpression="CustCode" DataTextField="CustCode"
                            DataNavigateUrlFields="CustCode" DataNavigateUrlFormatString="CustomerMasterAddEdit.aspx?New=N&&strCode={0}"
                            HeaderStyle-ForeColor="White" HeaderText="Customer Code" />
                        <asp:BoundField ItemStyle-HorizontalAlign="Left" SortExpression="CustName" DataField="CustName"
                            HeaderText="Customer Name" />
                        <asp:BoundField ItemStyle-HorizontalAlign="Left" SortExpression="DealerCode" DataField="DealerCode"
                            HeaderText="Dealer Code" />
                        <asp:BoundField ItemStyle-HorizontalAlign="Left" SortExpression="City" DataField="City"
                            HeaderText="City" />
                        <asp:BoundField ItemStyle-HorizontalAlign="Left" SortExpression="CustType" DataField="CustType"
