<%@ page language="C#" autoeventwireup="true" inherits="Admin_UserMaster, App_Web_nr1inqul" %>
...
<body>
    ...
    <form id="frmUserMasterMaster" runat="server">
        ...
        <ContentTemplate>
            <center>
               ...
               <br />
                ...
                <asp:GridView ID="gvUser" runat="server" BorderWidth="1" BorderColor="#666666"
                    GridLines="None" CellPadding="5" Width="95%" AllowPaging="true" EmptyDataText="No Record(s) Found."
                    AutoGenerateColumns="false" AllowSorting="true" OnRowDeleting="gvUser_RowDeleting"
                    OnSorting="gvUser_Sorting" PagerStyle-HorizontalAlign="Left" OnRowCommand="gvUser_RowCommand"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="UserId" HeaderStyle-CssClass="HiddenField" ItemStyle-CssClass="HiddenField"
                            HeaderText="ID" />
                        <asp:HyperLinkField ItemStyle-HorizontalAlign="Left" SortExpression="UserId" DataTextField="UserId"
                            DataNavigateUrlFields="UserId,RowId" DataNavigateUrlFormatString="UserMasterAddEdit.aspx?New=N&&strCode={0}&&strRowId={1}"
                            HeaderStyle-ForeColor="White" HeaderText="User Id" />
                        <asp:BoundField ItemStyle-HorizontalAlign="Left" SortExpression="UserName" DataField="UserName"
                            HeaderText="User Name" />
                        <asp:BoundField ItemStyle-HorizontalAlign="Left" SortExpression="UserType" DataField="UserType"
                            HeaderText="User Type" />
                        <asp:BoundField ItemStyle-HorizontalAlign="Left" SortExpression="Active" DataField="Active"
                            HeaderText="Status" />
                    </Columns>
